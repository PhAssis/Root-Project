...
function ProdutoComponent(props) {
  return (
    React.createElement('div', { className: 'col-12 col-sm-6 col-md-6 mb-3' },
  ...
  return (
    React.createElement('div', { className: 'carrinho' },
      React.createElement('div', { className: 'carrinho__itens' },
        Object.keys(props.itens).map((produtoId, index) => {
          return (
            React.createElement('div', { className: 'card carrinho__item', key: `item-carrinho-${index}` },
              React.createElement('div', { className: 'card-body' },
                ...
                React.createElement('button', { className: 'btn btn-danger btn-sm', onClick: props.onRemoveItemCarrinho.bind(null, produtoId) }, 'Remover')
              )
            )
          )
        })
